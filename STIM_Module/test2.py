...
class SeaofBTCapp(tk.Tk):
	...
	def __init__(self, *args, **kwargs):
		...
		#tk.Tk.iconbitmap(self, default="../Assets/Images/icon.png")
...
class StartPage(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		button4 = ttk.Button(self, text="Visit Page 4", command=lambda: controller.show_frame(PageFour))
		button4.pack()
...
class PageFour(tk.Frame):
	...
	def __init__(self, parent, controller):
		...
		elements = []
		elements.append(ttk.Label(self, text = "Enter the number of nodes:"))

		#elements[0].grid(row = 0, column = 0, pady=2, padx=2)		
  
		elements.append(ttk.Entry(self))

		for element in elements:
			element.pack(pady=2,padx=2)
			#element.grid(row = 0, column = 0, pady=2, padx=2)
